...
export default function CallHeroSection() {
  ...
  // Handle scroll detection for "Mumis pasitiki" section on mobile
  useEffect(() => {
    const handleScroll = () => {
      if (window.innerWidth < 768) { // Mobile only
        ...
        setHasScrolled(true); // Always show on desktop
      }
    };
  ...
  return (
    <section className="min-h-screen flex items-start md:items-center justify-center px-3 md:px-6 lg:px-12 pt-[108px] pb-6 md:pt-20 md:pb-12">
      <div className="max-w-5xl mx-auto text-center">
        <div className="max-w-3xl mx-auto mb-6 md:mb-8">
          <div className="inline-block mb-6 md:mb-7">
            <Badge 
              variant="outline" 
          ...
          <h1 className="font-bold tracking-tight mb-4 md:mb-5 leading-tight" data-testid="text-hero-title">
            <span className="text-[21px] md:text-[32px] lg:text-[36px]">Padidinsime Jūsų pardavimus su</span><br />
            <span className="text-[23px] md:text-[36px] lg:text-[40px] text-[#1d8263] md:bg-gradient-to-r md:from-[#1d8263] md:via-[#05785c] md:to-[#1d8263] md:bg-clip-text md:text-transparent md:animate-gradient">
              Dirbtinio Intelekto Darbuotojais
            </span><br />
            <span className="text-[21px] md:text-[32px] lg:text-[36px]">ir sutaupysime šimtus valandų</span>
          </h1>
        </div>

        <div className="relative max-w-2xl lg:max-w-3xl mx-auto mb-6 md:mb-8 px-2 md:px-0">
          <div 
        ...
        <div className="flex justify-center mt-6 mb-6 md:mt-8 md:mb-8">
          <Link href="/survey">
            <Button 
              size="lg" 
              variant="default"
        ...
        <div ref={trustSectionRef} className={`mt-12 md:mt-8 transition-opacity duration-300 ${hasScrolled ? 'opacity-100' : 'opacity-0 md:opacity-100'} ${hasScrolled ? 'pointer-events-auto' : 'pointer-events-none md:pointer-events-auto'}`}>
