  ...
  const renderSuccessStep = () => (
    <div className="text-center py-6 md:py-8">
      ...
      <Button
        ...
        className="mt-8 bg-white hover:bg-white/90 text-[#1d8263] font-extrabold py-6 px-8 rounded-xl shadow-lg shadow-black/20 hover:shadow-xl transition-all duration-300"
        size="lg"
      >
        Grįžti į pagrindinį
      </Button>
