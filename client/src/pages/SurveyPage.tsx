...
import { trackPageView, trackQuizResponse, trackEvent, trackButtonClick, initScrollTracking, initSessionDurationTracking, getSessionId } from "@/lib/analytics";
            ...
            {step === 1 && (
              <div className="space-y-8 animate-fade-in-slide">
                ...
                <div className="max-w-md mx-auto space-y-4">
                  <button
                    onClick={async () => {
                      handleBranchSelect('A');
                      await trackButtonClick('button-uzklausos', '/survey');
                    }}
                  ...
                  <button
                    onClick={async () => {
                      handleBranchSelect('B');
                      await trackButtonClick('button-pardavimai', '/survey');
                    }}
                    className={`w-full p-6 rounded-2xl border-2 transition-all duration-300 group ${
                      branch === 'B'
                        ? "border-[#1d8263] bg-gradient-to-br from-[#1d8263]/15 to-[#1d8263]/5 shadow-lg shadow-[#1d8263]/20 scale-[1.02]"
