  ...
  return (
    ...
    >
      <div className="md:flex md:items-center md:gap-6">
        ...
        <div className="relative px-4 md:px-6 pt-0 pb-5 md:py-6 md:w-1/2 md:flex md:items-center md:justify-center">
          <div className="relative z-10 w-full max-w-[360px] md:h-[240px] flex items-center justify-center">
