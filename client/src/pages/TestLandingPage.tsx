      ...
      <main className="flex-1 w-full max-w-[720px] mx-auto px-4 pt-16 pb-28 space-y-28">
        ...
        <section ref={heroRef} className="space-y-9 text-center">
          ...
          <div className="mt-8 space-y-16 md:space-y-20">
            ...
            <div className="max-w-[640px] mx-auto bg-gradient-to-br from-[#1d8263] via-[#167a5a] to-[#0f5f46] rounded-3xl p-5 md:p-10 shadow-lg">
              
              {/* MOBILE ONLY: VSL VIDEO SECTION - Inside the green box */}
              <div className="md:hidden w-full max-w-lg mx-auto relative group mb-5">
                <VSLVideo 
      ...
      <AnimatePresence>
        {showStickyCta && !hideStickyOnFinal && (
          ...
          >
            ...
            <div 
              className="backdrop-blur-xl px-4 pt-20 pb-[max(1.25rem,env(safe-area-inset-bottom))]"
              style={{
                background: 'linear-gradient(to top, rgba(255, 255, 255, 0.7) 0%, rgba(255, 255, 255, 0.7) 40%, transparent 100%)',
