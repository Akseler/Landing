  ...
  return (
    ...
    >
      <div className="md:flex md:items-center md:gap-6">
        <div className="px-5 md:px-7 pt-5 md:py-10 pb-4 md:w-1/2 md:flex md:flex-col md:justify-center md:text-left">
        ...
        <div className="relative px-4 md:px-6 pt-0 pb-5 md:py-10 md:w-1/2 md:flex md:items-center md:justify-center">
